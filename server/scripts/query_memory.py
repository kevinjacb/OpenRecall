...
hardcoded):
    ...
    export OPENRECALL_EMBED_MODEL=nomic-embed-text                # required
    export OPENRECALL_EMBED_BASE_URL=http://localhost:11434/v1     # default: Ollama
    export OPENRECALL_EMBED_API_KEY=...                            # optional (cloud)
    pip install -e '.[llm]'

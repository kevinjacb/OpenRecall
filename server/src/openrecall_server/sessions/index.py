...
timeline; that lives in the :class:`~openrecall_server.events.store.EventStore`.
...
class SessionSummary:
    ...
    ``com.openrecall.relay.http.dto.SessionSummaryDto``. Field names use Python
...
# The cursor codec now lives in `openrecall_server.paging` so /segments and

...
def test_from_env_reads_model_base_url_and_key():
    env = {
        ...
        "SENSE_LLM_MODEL": "gemma2",
        "SENSE_LLM_API_KEY": "secret",
    }
...
def test_from_env_requires_a_model():
    with pytest.raises(ValueError):
        OpenAICompatibleChatModel.from_env({"SENSE_LLM_BASE_URL": "http://x/v1"})

...
class ProactiveMessageBubbleTest {
    ...
    fun `ProactiveMessageBubble function exists with the expected signature`() {
        ...
        // com.sense.relay.ui.chat, named ProactiveMessageBubble, taking
        ...
        val fn = Class.forName("com.sense.relay.ui.chat.ProactiveMessageBubbleKt")
            .declaredMethods
            .single { it.name == "ProactiveMessageBubble" }
        assertNotNull(fn)
        assertEquals(
            "com.sense.relay.data.ChatMessage",

...
class ProactiveMessageBubbleTest {
    ...
    fun `ProactiveMessageBubble function exists with the expected signature`() {
        ...
        // com.openrecall.relay.ui.chat, named ProactiveMessageBubble, taking
        ...
        val fn = Class.forName("com.openrecall.relay.ui.chat.ProactiveMessageBubbleKt")
            .declaredMethods
            .single { it.name == "ProactiveMessageBubble" }
        assertNotNull(fn)
        assertEquals(
            "com.openrecall.relay.data.ChatMessage",

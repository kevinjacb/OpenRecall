package com.openrecall.relay.ble
...
/**
 * BLE central: finds the "OpenRecall" device, subscribes to its audio + ack notifications,
...
class SensorLink(private val context: Context, private val listener: Listener) {
     ...
     * scan callback sees one. Exposed so [com.openrecall.relay.RelayService]
     * can publish it to [com.openrecall.relay.relay.RelayController] on
    ...
    fun start() {
        ...
        Log.i(TAG, "scanning for OpenRecall…")
    }
    ...
    private val gattCallback = object : BluetoothGattCallback() {
        ...
        override fun onServicesDiscovered(g: BluetoothGatt, status: Int) {
            val svc = g.getService(SERVICE) ?: run {
                listener.onDisconnected("OpenRecall service not found"); return
            }

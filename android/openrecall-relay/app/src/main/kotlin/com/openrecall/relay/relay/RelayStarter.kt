 ...
 * ([com.openrecall.relay.ui.SetupActivity]). When the BLE/WS link drops, the
 ...
 * `onStartCommand` restores `server_url` / `token` from [com.openrecall.relay.store.ServerConfig]

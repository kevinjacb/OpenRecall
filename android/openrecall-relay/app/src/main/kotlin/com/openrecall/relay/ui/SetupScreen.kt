...
import com.openrecall.relay.setup.SetupStep
...
fun SetupScreen(
    ...
    Column(
        ...
        if (onCancel != null) {
            RecallDetailHeader(title = "Set up your device", onBack = onCancel)
        } else {
            Text(
...
private fun SetupStep.headline(): String = when (this) {
    ...
    is SetupStep.Scanning -> "Looking for your OpenRecall"
...
private fun SetupStep.supporting(): String = when (this) {
    ...
    is SetupStep.Done -> "Your OpenRecall is paired and the relay is running."
}

 ...
 * (mirrors [SessionApi]). [OpenRecallHttpClient] is `final` and does real OkHttp
...
private class HttpSpeakerApi(private val client: suspend () -> OpenRecallHttpClient) : SpeakerApi {
...
class SpeakerRepository(
    ...
    companion object {
        ...
        fun fromClient(clientProvider: suspend () -> OpenRecallHttpClient): SpeakerRepository =

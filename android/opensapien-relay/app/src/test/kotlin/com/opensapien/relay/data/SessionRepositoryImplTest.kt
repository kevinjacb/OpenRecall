...
import com.opensapien.relay.http.dto.SessionSummaryDto
...
class SessionRepositoryImplTest {
    ...
    @Test fun pagingFailureKeepsPageAndSurfacesInlineLoadError() = runTest {
        ...
        val err = assertIs<com.opensapien.relay.core.model.ApiError.Unreachable>(
    ...
    @Test fun successfulRetryClearsTheLoadError() = runTest {
        ...
        api.listError = IOException("down")
        repo.loadMoreSessions()
        assertIs<com.opensapien.relay.core.model.ApiError.Unreachable>(repo.observeLoadErrors().first())
    ...
    @Test fun httpStatusExceptionMapsToApiErrorHttp() = runTest {
        ...
        api.listError = com.opensapien.relay.http.HttpStatusException(503)
        repo.loadMoreSessions()
        val err = assertIs<com.opensapien.relay.core.model.ApiError.Http>(repo.observeLoadErrors().first())
    ...
    @Test fun observeSessionMapsSummaryAndEventsSortedBySeq() = runTest {
        ...
        val details = out.value as com.opensapien.relay.domain.model.SessionDetails
    ...
    @Test fun securityExceptionMapsToUnauthorized() = runTest {
        ...
        assertTrue(failure.error is com.opensapien.relay.core.model.ApiError.Unauthorized)
    }
}

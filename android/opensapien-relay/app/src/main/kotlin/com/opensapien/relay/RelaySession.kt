...
import com.opensapien.relay.protocol.CommandAck
import com.opensapien.relay.protocol.Bye
import com.opensapien.relay.protocol.Hello
import com.opensapien.relay.protocol.ServerMessage
import com.opensapien.relay.protocol.encode
import com.opensapien.relay.protocol.parseServerMessage
...
class RelaySession(
    ...
    private val speakerCache: com.opensapien.relay.data.SpeakerCache? = null,
) {
...
sealed interface RelayAction {
     ...
     *  on [com.opensapien.relay.data.RepositoryModule.repos]). The runtime's

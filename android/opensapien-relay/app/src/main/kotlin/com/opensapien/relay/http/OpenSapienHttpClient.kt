...
import com.opensapien.relay.http.dto.DtoJson
import com.opensapien.relay.http.dto.ServerStatusDto
import com.opensapien.relay.http.dto.SessionDetailsDto
import com.opensapien.relay.http.dto.SessionEventsDto
import com.opensapien.relay.http.dto.SessionsPageDto
import com.opensapien.relay.http.dto.SpeakerDto
import com.opensapien.relay.http.dto.SpeakersDto
import com.opensapien.relay.http.dto.RenameSpeakerRequestDto
import com.opensapien.relay.http.dto.ReassignSpeakerRequestDto
import com.opensapien.relay.http.dto.RenameSpeakerResponseDto
...
class OpenSapienHttpClient(
    ...
    private fun pinnedTrustManager(caPem: String): X509TrustManager {
        ...
        val keyStore = KeyStore.getInstance(KeyStore.getDefaultType()).apply {
            load(null)
            setCertificateEntry("opensapien-ca", pinnedCert)
        }
     ...
     * error into an [com.opensapien.relay.core.model.ApiError].
     */
 ...
 * classifier ([httpApiError]) can surface it as [com.opensapien.relay.core.model.ApiError.Http],
 * letting the UI distinguish a 503 ("Server is starting up") from a generic
 * network failure ([com.opensapien.relay.core.model.ApiError.Unreachable]).
 *

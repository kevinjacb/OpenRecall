package com.opensapien.relay.net
 ...
 * [com.opensapien.relay.http.OpenSapienHttpClient.gatewayPort]); provisioning stores it
 * in [com.opensapien.relay.store.Config.gatewayPort]; the relay passes it here.
 *

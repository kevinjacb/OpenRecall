package com.opensapien.relay.protocol
...
/**
 * §E control-plane envelope, mirroring the server's `opensapien_server.protocol.messages`.
 *
 ...
 * as binary §C.6 frames (see [com.opensapien.relay.RelaySession]); these are only control.
 *

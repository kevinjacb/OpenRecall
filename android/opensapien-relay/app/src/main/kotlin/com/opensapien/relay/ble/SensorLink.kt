package com.opensapien.relay.ble
...
/**
 * BLE central: finds the "OpenSapien" device, subscribes to its audio + ack notifications,
...
class SensorLink(private val context: Context, private val listener: Listener) {
     ...
     * scan callback sees one. Exposed so [com.opensapien.relay.RelayService]
     * can publish it to [com.opensapien.relay.relay.RelayController] on
    ...
    fun start() {
        ...
        Log.i(TAG, "scanning for OpenSapien…")
    }
    ...
    private val gattCallback = object : BluetoothGattCallback() {
        ...
        override fun onServicesDiscovered(g: BluetoothGatt, status: Int) {
            val svc = g.getService(SERVICE) ?: run {
                listener.onDisconnected("OpenSapien service not found"); return
            }

 ...
 * the semantic [SenseColors] tokens below via [LocalSenseColors].
 */
 ...
 * change is one file.
 *
 * Read them from composables via `SenseTheme.colors` — see [LocalSenseColors].
 */
...
/**
 * The active [SenseColors]. Provided by
 * [com.opensapien.relay.core.ui.OpenSapienTheme]; read through
 * [SenseTheme.colors] rather than this local directly.
 *
 ...
 */
val LocalSenseColors = staticCompositionLocalOf { SenseColors.light() }

...
import com.opensapien.relay.net.ServerSocket
import com.opensapien.relay.net.wsGatewayUrl
import com.opensapien.relay.relay.Backoff
 ...
 * connection" button (which re-launches this service via [com.opensapien.relay.relay.RelayStarter])
...
class RelayService : Service() {
    ...
    private companion object {
        ...
        const val CHANNEL = "opensapien_relay"
    }
    ...
    private fun buildNotification(): Notification {
        ...
        if (mgr.getNotificationChannel(CHANNEL) == null) {
            mgr.createNotificationChannel(
                NotificationChannel(CHANNEL, "OpenSapien Relay", NotificationManager.IMPORTANCE_LOW),
            )
        }
        return Notification.Builder(this, CHANNEL)
            .setContentTitle("OpenSapien Relay")

...
import com.opensapien.relay.http.dto.AgentResponseDto
import com.opensapien.relay.http.dto.AtomChipDto
    ...
    open suspend fun ask(
        ...
        when (dto.outcome) {
            ...
            "refuse" -> AgentOutcome.Refuse(
                ...
                code = com.opensapien.relay.http.ErrorCode.INTERNAL_ERROR,
...
sealed class AgentOutcome {
    ...
    data class Error(
        val code: com.opensapien.relay.http.ErrorCode,
        val message: String,
        val trace: TraceContext,
    ) : AgentOutcome()
}

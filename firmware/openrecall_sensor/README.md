...
| `ble_link` | ✅ builds + running | NimBLE GATT: audio notify / command-write / ack; advertises "OpenRecall" |
...
(`openrecall_sensor.c`), flash, and watch the monitor in three conditions — silence,

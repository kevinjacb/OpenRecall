/*
 * OpenSapien — firmware configuration (XIAO ESP32S3 Sense, ESP-IDF).
 *
 ...
 * sync with the server's wire contract (opensapien_server/ingest/audio_packet.py).
 *
...
#define OPENSAPIEN_SERVICE_UUID "6e9d0001-b5a3-4f6e-9b1a-7c2d5e8f0a10"
#define OPENSAPIEN_AUDIO_CHAR_UUID "6e9d0002-b5a3-4f6e-9b1a-7c2d5e8f0a10"   /* notify: §C.6 -> phone */
#define OPENSAPIEN_COMMAND_CHAR_UUID "6e9d0003-b5a3-4f6e-9b1a-7c2d5e8f0a10" /* write: signed §D in */
#define OPENSAPIEN_ACK_CHAR_UUID "6e9d0004-b5a3-4f6e-9b1a-7c2d5e8f0a10"     /* notify: command acks/status */
